...
function App() {
  ...
  const divStyle = {
    ...
    // Add any necessary styles for the visible state
  };
        ...
        <div id="carouselExampleIndicators" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img
                src="https://trident.ac.in/maintain/wp-content/uploads/2021/02/image.png"
                class="d-block w-100"
                height="500"
                width="150"
                alt="..."
            ...
            <div class="carousel-item">
              <img
                src="https://pbs.twimg.com/media/FjSKorFVIAAXJNP.jpg"
                class="d-block w-100"
                height="500"
                width="150"
                alt="..."
            ...
            <div class="carousel-item">
              <img
                src="https://www.alletec.com/media/blogs/role-of-digital-transformation-in-adoption-of-nep-2020.webp"
                class="d-block w-100"
                height="500"
                width="150"
                alt="..."
